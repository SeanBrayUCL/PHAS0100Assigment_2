...
TargetedPedestrian ped(origin, destination, velocity, position, desired_speed, relaxation_time);
...
double unit_speed = 1;
TargetedPedestrian* unit_desired_speed_pedestrian = new  TargetedPedestrian(origin, destination, zero_velocity, position, unit_speed, relaxation_time);

// one dimensional unit desired speed pedestrian
sfm::pos2d one_d_destination(1,0); 
sfm::pos2d one_d_position(0,0); 
TargetedPedestrian* one_d_pedestrian= new TargetedPedestrian(origin, one_d_destination, zero_velocity, one_d_position, unit_speed, relaxation_time);
...
TargetedPedestrian* pedestrian_1 = new TargetedPedestrian(origin, destination_1, velocity_1, position_1, desired_speed, relaxation_time);
TargetedPedestrian* pedestrian_2 = new TargetedPedestrian(origin, destination_2, velocity_2, position_2, desired_speed, relaxation_time);
TargetedPedestrian* pedestrian_3= new TargetedPedestrian(origin, destination_3, velocity_3, position_3, desired_speed, relaxation_time);
